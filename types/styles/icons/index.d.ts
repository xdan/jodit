...
export { about, addcolumn, addrow, angle_left, angle_right, angle_down, angle_up, arrows_alt, arrows_h, attachment, bin, bold, brush, cancel, center, chain_broken, check_square, check, copyformat, crop, cut, dedent, dots, enter, eraser, eye, file, folder, font, fontsize, fullsize, hr, image, info_circle, indent, italic, justify, left, link, lock, menu, merge, ol, omega, outdent, paragraph, pencil, plus, print, redo, resize, resizer, right, save, select_all, shrink, source, splitg, splitv, strikethrough, subscript, superscript, table, th_list, th, ul, underline, undo, unlink, unlock, update, upload, valign, video };
