...
export declare type ControlType = {
    ...
    isActiveChild?: (editor: IViewBased | Jodit, control: ControlType, button?: ToolbarButton) => boolean;
    ...
    css?: {
        ...
        [key: string]: (editor: IViewBased | Jodit, value: string) => boolean;
    };
    /**
...
export declare type Buttons = Array<string | ControlType> | string;
