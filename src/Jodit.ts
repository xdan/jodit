...
export class Jodit extends Component {
    ...
    private __createEditor() {
        ...
        // proxy events
        this.events
            .on(this.editor, 'keydown keyup keypress mousedown mouseup mousepress click copy cut dragstart drop dragover paste resize touchstart touchend focus blur', (event: Event): false | void => {
                if (this.options.readonly) {
                    return;
                }
