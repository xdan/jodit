...
(function(e: Element) {
    e.matches || (e.matches = (e as any).matchesSelector !== undefined ? (e as any).matchesSelector : function(this: Element, selector: string) {
...
if (!Array.prototype.includes) {
    Object.defineProperty(Array.prototype, "includes", {
        value(searchElement: any[], fromIndex: number) {
            ...
            function sameValueZero(x: number, y: any) {
