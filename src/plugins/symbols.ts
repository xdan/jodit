    ...
    constructor(editor: Jodit) {
        editor.events
            .on("generateSpecialCharactersTable.symbols", () => {
                const container: HTMLDivElement = dom('<div class="jodit_symbols-container">' +
                    ...
                    preview: HTMLDivElement = container.querySelector(".jodit_symbols-preview") as HTMLDivElement,
                    table: HTMLTableElement = container.querySelector("table") as HTMLTableElement,
