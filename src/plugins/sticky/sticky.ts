...
export class sticky extends Plugin {
	...
	afterInit(jodit: IJodit): void {
		jodit.e
			...
			.on('getStickyState.sticky', () => this.__isToolbarSticked);
	}
	...
	private __onScroll(): void {
		...
		if (
			...
			this.__isToolbarSticked !== doSticky
		) {
